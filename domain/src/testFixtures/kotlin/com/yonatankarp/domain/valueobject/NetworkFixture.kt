...
object NetworkFixture {
    ...
    val randomValidNetworkIpv4: Network get() = Network(IPFixture.randomIPv4, "RandomNetwork", Random.nextUInt(8u, 33u))
    val randomValidNetworkIpv6: Network get() = Network(IPFixture.randomIPv6, "RandomNetwork", Random.nextUInt(8u, 33u))
}
